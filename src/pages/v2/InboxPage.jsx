      ...
      <div className="rounded-xl bg-white dark:bg-warm-gray-800 border border-gray-100 dark:border-warm-gray-700 p-4">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <div className="rounded-lg border border-gray-100 dark:border-warm-gray-700 p-3">
            ...
            <input className="mt-2 w-full px-3 py-2 rounded bg-gray-50 dark:bg-warm-gray-900 border border-gray-200 dark:border-warm-gray-700" placeholder="Nhập ghi chú..."/>
          </div>
          <div className="rounded-lg border border-gray-100 dark:border-warm-gray-700 p-3">
            <p className="text-sm text-gray-500">Tạo nhiệm vụ</p>
            <input className="mt-2 w-full px-3 py-2 rounded bg-gray-50 dark:bg-warm-gray-900 border border-gray-200 dark:border-warm-gray-700" placeholder="Tên nhiệm vụ..."/>
          </div>
        </div>
      </div>
    </Layout>
