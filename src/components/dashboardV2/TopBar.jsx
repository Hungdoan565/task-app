    ...
    <div className="flex items-center gap-3 p-3 bg-white/80 dark:bg-warm-gray-900/70 backdrop-blur border-b border-gray-200 dark:border-warm-gray-800 sticky top-0 z-10 rounded-xl">
      <div className="relative dv2-search w-64 md:w-80 max-w-full">
        ...
        <input
          ...
          aria-label="Tìm kiếm"
          onFocus={(e)=>{e.currentTarget.parentElement.style.width='28rem'}}
          onBlur={(e)=>{e.currentTarget.parentElement.style.width='20rem'}}
        />
      </div>
      ...
      <ThemeToggle />
      <button onClick={onRipple} className="ripple-container relative px-3 py-2 rounded-lg bg-emerald-600 text-white text-sm font-semibold flex items-center gap-1">
